...
int main(int argc, char const *argv[]) {
   if (argc == 2 && strcmp(argv[1], "help") == 0) {
      (void)printf("data type | examples\n");
      (void)printf("byte      | 00000000, 1110'0011\n");
   }

   if (argc != 4) {
      // (void)printf("Usage: binb <file> <count> <data_type> <data>\n");
      (void)printf("Usage: binb <file> <data_type> <data>\n");
      (void)printf("       binb help\n");
      return 1;
   }
